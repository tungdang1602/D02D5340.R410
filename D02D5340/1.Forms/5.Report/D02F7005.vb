...
#Region "Form Load"
    ...
    Private Sub Loadlanguage()
        '================================================================ 
        Me.Text = rl3("Bao_cao_phan_tich_tai_san") & " - D02F7005" & UnicodeCaption(gbUnicode)
        '================================================================ 
        ...
        '================================================================ 
        grpDivision.Text = rl3("Don_vi") 'Đơn vị
        grpReport.Text = rl3("Bao_cao") 'Báo cáo
        grpGroup.Text = rl3("Chon_nhom") 'Chọn nhóm
        grpTimeInfo.Text = rl3("Thong_tin_thoi_gian") 'Thông tin thời gian
        '================================================================ 
    ...
    Private Sub D02F7005_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        'Them ngay 18/2/2013 theo ID 54104 của Bảo Trân bởi Văn Vinh
        Dim sSQL As String = "--Xoa du lieu bang tam D91T2024" & vbCrLf
        sSQL &= "DELETE D91T2024 WHERE	UserID = " & SQLString(gsUserID) & " AND FormID = 'D02F7005'"
        ExecuteSQL(sSQL)
    End Sub
...
#Region "Load Combo"
    ...
    Private Sub LoadTDBCombo()
        ...
        'Load tdbcReportID
        sSQL = "Select ReportCode, ReportName1" & UnicodeJoin(gbUnicode) & " as ReportName1,  ReportName2" & UnicodeJoin(gbUnicode) & " as ReportName2, ReportID , Selection01,  Selection02, Selection03, Selection04, Selection05,BracketNegative, DecimalPlaces, AmountFormat, Customized From D02T3110  WITH (NOLOCK)  Where Disabled = 0 Order By ReportCode, ReportName1"
    ...
    Private Function CreatedtSelection() As DataTable
        ...
        sSQL = " Select 1 as DisplayOrder,Code, Description" & UnicodeJoin(gbUnicode) & " as Description, Type, DivisionID " & vbCrLf
        sSQL += " From D02V3037 " & vbCrLf
        sSQL += "Union All   Select 0 as DisplayOrder,'%' as Code , " & AllName & " As Description, '%' As TypeD, '%' As DivisionID " & vbCrLf
    ...
    Private Function CreatedtSelectionCaption() As DataTable
        Dim sSQL As String = ""
        sSQL = "Select  Code, Description" & UnicodeJoin(gbUnicode) & "  as Description,Language From D02V3101 Where Language = " & SQLString(gsLanguage)
        Return ReturnDataTable(sSQL)
    End Function
    ...
    Private Sub LoadtdbcSelection(ByVal ID As String, ByVal tdbcSelectionIDFrom As C1.Win.C1List.C1Combo, ByVal tdbcSelectionIDTo As C1.Win.C1List.C1Combo)
        ...
        dt = ReturnTableFilter(dtSelection, "(Type = " & SQLString(ID) & " Or Type = '%') And (DivisionID Like " & SQLString(ReturnValueC1Combo(tdbcDivisionID)) & " Or DivisionID = '%')")
        'dt1 = ReturnTableFilter(dt, " DivisionID Like " & SQLString(ReturnValueC1Combo(tdbcDivisionID)))
...
#Region "Events tdbcReportID with txtReportName"
    ...
    Private Sub LoadCaptionSelection()
        ...
        If tdbcReportID.Text.Trim <> "" Then
            lblSelection01IDFrom.Font = FontUnicode(gbUnicode, FontStyle.Underline)
            lblSelection02IDFrom.Font = FontUnicode(gbUnicode, FontStyle.Underline)
            lblSelection03IDFrom.Font = FontUnicode(gbUnicode, FontStyle.Underline)
            lblSelection04IDFrom.Font = FontUnicode(gbUnicode, FontStyle.Underline)
            lblSelection05IDFrom.Font = FontUnicode(gbUnicode, FontStyle.Underline)
...
#Region "Events tdbcSelection01IDFrom"
    ...
    Private Sub tdbcSelection01IDFrom_Close(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tdbcSelection01IDFrom.LostFocus
        If tdbcSelection01IDFrom.FindStringExact(tdbcSelection01IDFrom.Text) = -1 Then tdbcSelection01IDFrom.Text = ""
        SetValueTo(tdbcSelection01IDFrom, tdbcSelection01IDTo, True)
    End Sub
    ...
    Private Sub tdbcSelection01IDFrom_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles tdbcSelection01IDFrom.KeyDown
        If e.KeyCode = Keys.F2 Then
            ...
            Dim sSQL As String = "SELECT Type As SelectionGroup, Code AS SelectionID, Description" & UnicodeJoin(gbUnicode) & " AS SelectionName FROM	D02V3037  WHERE	[Type] = " & SQLString(tdbcReportID.Columns("Selection01").Text) & " ORDER BY Code"
            Me.Cursor = Cursors.WaitCursor
            Dim chuoi As String = HotKeyF2D91F6020(sSQL, tdbcSelection01IDFrom, tdbcSelection01IDTo, 1) 'Gán giá trị sau khi tìm kiếm
            Me.Cursor = Cursors.Default
        End If
    End Sub
...
#Region "Events tdbcSelection01IDTo"
    ...
    Private Sub tdbcSelection01IDTo_Close(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tdbcSelection01IDTo.LostFocus
    ...
    Private Sub tdbcSelection01IDTo_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles tdbcSelection01IDTo.KeyDown
        If e.KeyCode = Keys.F2 Then
            ...
            Dim sSQL As String = "SELECT Type As SelectionGroup, Code AS SelectionID, Description" & UnicodeJoin(gbUnicode) & " AS SelectionName FROM	D02V3037  WHERE	[Type] = " & SQLString(tdbcReportID.Columns("Selection01").Text) & " ORDER BY Code"
            Me.Cursor = Cursors.WaitCursor
            Dim chuoi As String = HotKeyF2D91F6020(sSQL, tdbcSelection01IDTo, tdbcSelection01IDTo, 1) 'Gán giá trị sau khi tìm kiếm
            Me.Cursor = Cursors.Default
        End If
    End Sub
...
#Region "Events tdbcSelection02IDFrom"
    ...
    Private Sub tdbcSelection02IDFrom_Close(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tdbcSelection02IDFrom.LostFocus
        If tdbcSelection02IDFrom.FindStringExact(tdbcSelection02IDFrom.Text) = -1 Then tdbcSelection02IDFrom.Text = ""
        SetValueTo(tdbcSelection02IDFrom, tdbcSelection02IDTo, True)
    End Sub
    ...
    Private Sub tdbcSelection02IDFrom_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles tdbcSelection02IDFrom.KeyDown
        If e.KeyCode = Keys.F2 Then
            ' If tdbcSel01IDFrom.Tag Is Nothing Then Exit Sub 'tdbc.Tag lưu câu SQL đổ nguồn cho combo
            Dim sSQL As String = "SELECT Type As SelectionGroup,	Code AS SelectionID, Description" & UnicodeJoin(gbUnicode) & " AS SelectionName FROM	D02V3037  WHERE	[Type] = " & SQLString(tdbcReportID.Columns("Selection02").Text) & " ORDER BY Code"
            Me.Cursor = Cursors.WaitCursor
            Dim chuoi As String = HotKeyF2D91F6020(sSQL, tdbcSelection02IDFrom, tdbcSelection02IDTo, 1) 'Gán giá trị sau khi tìm kiếm
            Me.Cursor = Cursors.Default
        End If
...
#Region "Events tdbcSelection02IDTo"
    ...
    Private Sub tdbcSelection02IDTo_Close(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tdbcSelection02IDTo.LostFocus
    ...
    Private Sub tdbcSelection02IDTo_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles tdbcSelection02IDTo.KeyDown
        If e.KeyCode = Keys.F2 Then
            ...
            Dim sSQL As String = "SELECT Type As SelectionGroup,	Code AS SelectionID, Description" & UnicodeJoin(gbUnicode) & " AS SelectionName FROM	D02V3037  WHERE	[Type] = " & SQLString(tdbcReportID.Columns("Selection02").Text) & " ORDER BY Code"
            Me.Cursor = Cursors.WaitCursor
            Dim chuoi As String = HotKeyF2D91F6020(sSQL, tdbcSelection02IDTo, tdbcSelection02IDTo, 1) 'Gán giá trị sau khi tìm kiếm
            Me.Cursor = Cursors.Default
        End If
    End Sub
...
#Region "Events tdbcSelection03IDFrom"
    ...
    Private Sub tdbcSelection03IDFrom_Close(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tdbcSelection03IDFrom.LostFocus
        If tdbcSelection03IDFrom.FindStringExact(tdbcSelection03IDFrom.Text) = -1 Then tdbcSelection03IDFrom.Text = ""
        SetValueTo(tdbcSelection03IDFrom, tdbcSelection03IDTo, True)
    End Sub
    ...
    Private Sub tdbcSelection03IDFrom_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles tdbcSelection03IDFrom.KeyDown
        If e.KeyCode = Keys.F2 Then
            ' If tdbcSel01IDFrom.Tag Is Nothing Then Exit Sub 'tdbc.Tag lưu câu SQL đổ nguồn cho combo
            Dim sSQL As String = "SELECT Type As SelectionGroup,	Code AS SelectionID, Description" & UnicodeJoin(gbUnicode) & " AS SelectionName FROM	D02V3037  WHERE	[Type] = " & SQLString(tdbcReportID.Columns("Selection03").Text) & " ORDER BY Code"
            Me.Cursor = Cursors.WaitCursor
            Dim chuoi As String = HotKeyF2D91F6020(sSQL, tdbcSelection03IDFrom, tdbcSelection03IDTo, 1) 'Gán giá trị sau khi tìm kiếm
            Me.Cursor = Cursors.Default
        End If
    End Sub
...
#Region "Events tdbcSelection03IDTo"
    ...
    Private Sub tdbcSelection03IDTo_Close(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tdbcSelection03IDTo.LostFocus
    ...
    Private Sub tdbcSelection03IDTo_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles tdbcSelection03IDTo.KeyDown
        If e.KeyCode = Keys.F2 Then
            ...
            Dim sSQL As String = "SELECT Type As SelectionGroup,	Code AS SelectionID, Description" & UnicodeJoin(gbUnicode) & " AS SelectionName FROM	D02V3037  WHERE	[Type] = " & SQLString(tdbcReportID.Columns("Selection03").Text) & " ORDER BY Code"
            Me.Cursor = Cursors.WaitCursor
            Dim chuoi As String = HotKeyF2D91F6020(sSQL, tdbcSelection03IDTo, tdbcSelection03IDTo, 1) 'Gán giá trị sau khi tìm kiếm
            Me.Cursor = Cursors.Default
        End If
    End Sub
...
#Region "Events tdbcSelection04IDFrom"
    ...
    Private Sub tdbcSelection04IDFrom_Close(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tdbcSelection04IDFrom.LostFocus
        If tdbcSelection04IDFrom.FindStringExact(tdbcSelection04IDFrom.Text) = -1 Then tdbcSelection04IDFrom.Text = ""
        SetValueTo(tdbcSelection04IDFrom, tdbcSelection04IDTo, True)
    End Sub
    ...
    Private Sub tdbcSelection04IDFrom_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles tdbcSelection04IDFrom.KeyDown
        If e.KeyCode = Keys.F2 Then
            ' If tdbcSel01IDFrom.Tag Is Nothing Then Exit Sub 'tdbc.Tag lưu câu SQL đổ nguồn cho combo
            Dim sSQL As String = "SELECT Type As SelectionGroup,	Code AS SelectionID, Description" & UnicodeJoin(gbUnicode) & " AS SelectionName FROM	D02V3037  WHERE	[Type] = " & SQLString(tdbcReportID.Columns("Selection04").Text) & " ORDER BY Code"
            Me.Cursor = Cursors.WaitCursor
            Dim chuoi As String = HotKeyF2D91F6020(sSQL, tdbcSelection04IDFrom, tdbcSelection04IDTo, 1) 'Gán giá trị sau khi tìm kiếm
            Me.Cursor = Cursors.Default
        End If
    End Sub
...
#Region "Events tdbcSelection04IDTo"
    ...
    Private Sub tdbcSelection04IDTo_Close(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tdbcSelection04IDTo.LostFocus
    ...
    Private Sub tdbcSelection04IDTo_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles tdbcSelection04IDTo.KeyDown
        If e.KeyCode = Keys.F2 Then
            ...
            Dim sSQL As String = "SELECT Type As SelectionGroup,	Code AS SelectionID, Description" & UnicodeJoin(gbUnicode) & " AS SelectionName FROM	D02V3037  WHERE	[Type] = " & SQLString(tdbcReportID.Columns("Selection04").Text) & " ORDER BY Code"
            Me.Cursor = Cursors.WaitCursor
            Dim chuoi As String = HotKeyF2D91F6020(sSQL, tdbcSelection04IDTo, tdbcSelection04IDTo, 1) 'Gán giá trị sau khi tìm kiếm
            Me.Cursor = Cursors.Default
        End If
    End Sub
...
#Region "Events tdbcSelection05IDFrom"
    ...
    Private Sub tdbcSelection05IDFrom_Close(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tdbcSelection05IDFrom.LostFocus
        If tdbcSelection05IDFrom.FindStringExact(tdbcSelection05IDFrom.Text) = -1 Then tdbcSelection05IDFrom.Text = ""
        SetValueTo(tdbcSelection05IDFrom, tdbcSelection05IDTo, True)
    End Sub
    ...
    Private Sub tdbcSelection05IDFrom_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles tdbcSelection05IDFrom.KeyDown
        If e.KeyCode = Keys.F2 Then
            ' If tdbcSel01IDFrom.Tag Is Nothing Then Exit Sub 'tdbc.Tag lưu câu SQL đổ nguồn cho combo
            Dim sSQL As String = "SELECT Type As SelectionGroup,	Code AS SelectionID, Description" & UnicodeJoin(gbUnicode) & " AS SelectionName FROM	D02V3037  WHERE	[Type] = " & SQLString(tdbcReportID.Columns("Selection05").Text) & " ORDER BY Code"
            Me.Cursor = Cursors.WaitCursor
            Dim chuoi As String = HotKeyF2D91F6020(sSQL, tdbcSelection05IDFrom, tdbcSelection05IDTo, 1) 'Gán giá trị sau khi tìm kiếm
            Me.Cursor = Cursors.Default
        End If
    End Sub
...
#Region "Events tdbcSelection05IDTo"
    ...
    Private Sub tdbcSelection05IDTo_Close(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tdbcSelection05IDTo.LostFocus
...
#Region "Events tdbcPeriodFrom"
    ...
    Private Sub tdbcPeriodFrom_Close(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tdbcPeriodFrom.LostFocus
...
#Region "Events tdbcPeriodTo"
    ...
    Private Sub tdbcPeriodTo_Close(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tdbcPeriodTo.LostFocus
...
#Region "Button Click"
    ...
    Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        sReportCaption = rl3("Bao_cao_phan_tich_tai_san") & " - " & sReportName
        ...
        If tdbcReportID.Columns("Customized").Value.ToString = "1" Then
            sPathReport = UnicodeGetReportPath(gbUnicode, D02Options.ReportLanguage, "1") & sReportName & ".rpt"
        Else
        ...
        sSQL = SQLStoreD02P3110()
        If tdbcPeriodFrom.Text <> tdbcPeriodTo.Text Then
            sTime = IIf(gbUnicode, ConvertVniToUnicode(rL3("Ky_V")), rL3("Ky_V")).ToString & " " & tdbcPeriodFrom.Text & " - " & tdbcPeriodTo.Text
        Else
            sTime = IIf(gbUnicode, ConvertVniToUnicode(rL3("Ky_V")), rL3("Ky_V")).ToString & " " & tdbcPeriodFrom.Text
        End If
        With report
            .OpenConnection(conn)
            .AddParameter("Time", sTime, ReportDataType.lmReportString)
    ...
    '#---------------------------------------------------------------------------------------------------
    '# Title: SQLStoreD02P3110
    '# Created User: Thiên Huỳnh
    '# Created Date: 05/01/2009 10:05:05
    '# Modified User: 
    '# Modified Date: 
    '# Description: 
    '#---------------------------------------------------------------------------------------------------
    Private Function SQLStoreD02P3110() As String
        Dim sSQL As String = ""
        sSQL &= "Exec D02P3110 "
        ...
        sSQL &= SQLNumber(gbUnicode) & COMMA 'ToYear, int, NOT NULL
        'Bổ xung ngày 17/07/2012 theo THIHUAN
        sSQL &= "N" & SQLString(sFind)
        Return sSQL
    End Function
#End Region
    'Bổ xung ngày 17/07/2012 theo THIHUAN
